 ...
 */
public class AntWalkIConfig extends  AntWalkConfig{
    ...
    public AntWalkIConfig(int amount_of_ants){
        super();
    ...
    public AntWalkIConfig(int amount_of_ants, int size) {
        super();
    ...
    public AntWalkIConfig(int amount_of_ants, int height, int width) {
        super();
