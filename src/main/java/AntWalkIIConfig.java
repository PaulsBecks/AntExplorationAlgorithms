 ...
 */
public class AntWalkIIConfig extends  AntWalkConfig{
    ...
    public AntWalkIIConfig(int amount_of_ants){
        super();
    ...
    public AntWalkIIConfig(int amount_of_ants, int size) {
        super();
    ...
    public AntWalkIIConfig(int amount_of_ants, int height, int width) {
        super();
